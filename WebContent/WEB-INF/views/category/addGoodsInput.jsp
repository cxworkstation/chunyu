...
<html>
  <head>
    ...
    <script type="text/javascript">
         function doit() {
             var img='<%=request.getAttribute("pic")%>';
             if(img=='null') {
                 alert('必须给商品添加图片');
                 return;
             }
             ...
             var url='<%=basePath%>category/manage/addGoods';
             $.ajax({
                  url:url,
                  type:'POST',
                  data:{
  ...
  <body>
 <center>
  <form action="<%=basePath %>category/manage/addGoodsImg" method="post" enctype="multipart/form-data">
        ...
        <div>
          ...
          <table>
             ...
             <tr>
               ...
               <td>
                 <textarea rows="4" cols="30" name="introduction"><%Object o2=request.getAttribute("introduction");if(o2!=null) {%><%=o2%><%}%></textarea>
               </td>
             </tr>
          </table>
        </div>
