...
<html>
  <head>
    ...
    <script type="text/javascript">
         function doit() {
             ...
             var url='<%=basePath%>homepage/manage/classify/addClassifyGoods';
             $.ajax({
                  url:url,
                  type:'POST',
                  data:{
  ...
  <body>
 <center>
  <form action="<%=basePath %>homepage/manage/classify/upGoodsImg" method="post" enctype="multipart/form-data">
