...
<html>
  <head>
    ...
    <script type="text/javascript">
         function doit() {
             ...
             var url='<%=basePath%>homepage/manage/module/addModuleGoods';
             $.ajax({
                  url:url,
                  type:'POST',
                  data:{
  ...
  <body>
 <center>
  <form action="<%=basePath %>homepage/manage/module/uploadModuleGoodsImg" method="post" enctype="multipart/form-data">
