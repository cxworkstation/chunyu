...
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="<%=basePath %>imgs/backstage/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="<%=basePath %>imgs/backstage/logo.gif" /></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username">${sysuser.userName }</span>，欢迎使用内容管理系统！
        	[<a href="<%=basePath %>index" target="_blank">网站首页</a>]
        	[<a href="<%=basePath %>admin/manage/main" target="main">后台主页</a>]
        	[<a href="<%=basePath %>backstage/user_pwdinput?id=${sysuser.id}&type=1" target="main">修改密码</a>]
        	[<a href="<%=basePath %>sys/user_exit?id=${sysuser.id}" target="_parent">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
      <tr>
		...
		<dl id="tpa">
		<dd class='img'><a href="javascript:ChangeMenu(-1);"><img vspace="5" src="<%=basePath %>imgs/backstage/arrl.gif" border="0" width="5" height="8" alt="缩小左框架"  title="缩小左框架" /></a></dd>
		<dd class='img'><a href="javascript:ChangeMenu(0);"><img vspace="3" src="<%=basePath %>imgs/backstage/arrfc.gif" border="0" width="12" height="12" alt="显示/隐藏左框架" title="显示/隐藏左框架" /></a></dd>
		<dd class='img' style="margin-right:10px;"><a href="javascript:ChangeMenu(1);"><img vspace="5" src="<%=basePath %>imgs/backstage/arrr.gif" border="0" width="5" height="8" alt="增大左框架" title="增大左框架" /></a></dd></dl>
		</td>
      </tr>
    </table></td>
  </tr>
